...
public class OldSchool extends Fragment {
    ...
    FragmentOldSchoolBinding binding;
    private View view;
    private Context context;
    private List<Juego> juegos = new ArrayList<>();

    private static final String PATH_OLDSCHOOL = "viejaEscuela";
    ...
    private void configGlobals() {
        MainActivity.GLOBALS.put("OldFragment",this);
    }
    ...
    private void configToolBar() {
        ...
        binding.appBar.setNavigationOnClickListener(new NavigationIconClickListener(
                context, view.findViewById(R.id.gridOldSchool),
    ...
    private void configRecycler() {
        ...
        DatabaseReference reference = database.getReference(PATH_OLDSCHOOL);
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                binding.rcvlOldSchool.getAdapter().notifyDataSetChanged();
            }
        ...
        binding.rcvlOldSchool.setHasFixedSize(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(context, RecyclerView.HORIZONTAL,false);
        binding.rcvlOldSchool.setLayoutManager(layoutManager);
        binding.rcvlOldSchool.setAdapter(new JuegosAdapter(juegos));
    }
}